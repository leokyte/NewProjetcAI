// Source code:
// https://github.com/computerjazz/react-native-draggable-flatlist/blob/master/index.js
...
class SortableFlatList extends Component {
	...
	renderItem = ({ item, index }) => {
		...
		const spacerSize =
			isSpacerRow && this._measurements[activeRow] ? this._measurements[activeRow][horizontal ? 'width' : 'height'] : 0
		const endPadding =
			index === data.length - 1 &&
